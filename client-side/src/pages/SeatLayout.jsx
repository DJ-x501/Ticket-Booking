...
const SeatLayout = () => {
  ...
  function handleSeatClick(seatId){
    ...
    if(!selectedSeats.includes(seatId)&& selectedSeats.length >4){
      return toast("you can only select 5 seasts")
    };
  ...
  return show ? (
    <div className='flex flex-col md:flex-row px-6 md:px-16 lg:px-40 py-30 md:pt-50'>
      <div className='w-60 bg-primary/10 border border-primary/20 ronnded-lg py-10
      ...
      <div className="relative flex flex-1 flex-col items-center max-md:mt-16">
        ...
        <img src={assets.screenImage} alt='image' />
