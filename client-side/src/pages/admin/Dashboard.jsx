...
const Dashboard = () => {
    ...
    const dashboardCards = [
        {title:"Total Bookings", value:dashboradData.totalBookings || "0",icon:ChartLineIcon},
        {title:"Total Revenue", value:currency+dashboradData.totalRevenue || "0",icon:CircleDollarSignIcon},
        {title:"Active Shows", value:dashboradData.activeShows.length ||"0",icon:PlayCircleIcon},
        {title:"Total Users", value:dashboradData.totalUser|| "0",icon:UserIcon}
    ];
  ...
  return !loading ?  (
    <div>
        ...
        <div className="relative flex flex-wrap gap-4 mt-6">
            ...
            <div className="flex flex-wrap gap-4 w-full">
                {dashboardCards.map((card,index)=>(
                    <div key={index} className="flex items-center justify-between px-4 py-3 bg-primary/10 border boder-primary/20
        ...
        <div className="relative flex flex-wrap gap-6 mt-4 max-w-5xl">
            ...
            {dashboradData.activeShows.map((show)=>(
